...
<body class="font-sans antialiased text-text-primary bg-neutral-cream">
        ...
        <div x-data="{
            ...
            <template x-for="toast in toasts" :key="toast.id">
                <div x-show="true" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div :class="{ 'bg-emerald-300': toast.type === 'success', 'bg-red-300': toast.type === 'error' }"
    ...
    <div class="min-h-screen flex w-full">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 lg:p-12 relative bg-neutral-cream">
            ...
            <div
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5" x-data="{ submitting: false }"
                    ...
                    <!-- Email/Username -->
                    <div>
                        <label for="email" class="block text-sm font-medium text-text-secondary mb-1.5 ml-1">Username /
                            Email</label>
        ...
        <div class="hidden lg:flex w-1/2 bg-pastel-sky/10 items-center justify-center relative p-12 overflow-hidden">
            ...
            <div
                class="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-neutral-cream to-pastel-sky/20 opacity-50">
            </div>
            <div
                class="absolute top-20 right-20 w-72 h-72 bg-pastel-sky/30 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob">
            </div>
            <div
                class="absolute bottom-20 left-20 w-72 h-72 bg-pastel-lavender/30 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000">
            </div>
            <div
                class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-pastel-peach/20 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000">
            </div>
            ...
            <div class="relative w-full max-w-lg z-10 flex flex-col items-center">
                ...
                <div class="w-full aspect-square relative mb-8 transition-transform duration-700 hover:scale-105">
                    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" class="w-full h-full drop-shadow-2xl">
                        ...
                        <rect x="120" y="100" width="260" height="300" rx="24" fill="url(#screenGradient)"
                        ...
                        <g transform="translate(340, 260) rotate(-10)">
                            ...
                            <path d="M-8 0 L-2 6 L 10 -6" stroke="white" stroke-width="4" fill="none"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </g>

                        <!-- Decorative Elements -->
                        <circle cx="100" cy="380" r="20" class="fill-pastel-lavender/60 animate-bounce"
                            style="animation-duration: 3s;" />
                        <rect x="380" y="120" width="20" height="20" rx="4" class="fill-pastel-rose/60 animate-pulse"
