    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                {{-- Laravel Logo --}}
                {{-- Application Logo --}}
                <div class="flex justify-center w-full lg:w-[438px]">
                    <x-application-logo
                        class="w-24 h-24 text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-6" />
                </div>
