...
@section('header-title', 'Tambah Aset Baru')
@section('header-subtitle', 'Daftarkan aset baru ke inventaris')
            ...
            <form method="POST" action="{{ route('admin.assets.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="asset_code" value="{{ old('asset_code') }}" required placeholder="AST-001"
                    ...
                    <div>
                        ...
                        <select name="condition" required
                            ...
                            <option value="dihapuskan" {{ old('condition') === 'dihapuskan' ? 'selected' : '' }}>Dihapuskan</option>
                        </select>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-sm font-medium">Rp</span>
                            <input type="number" name="current_value" value="{{ old('current_value') }}" min="0" step="0.01" placeholder="Sama dengan harga pembelian jika kosong"
                                class="w-full pl-12 pr-4 py-2.5 bg-white dark:bg-card-dark border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-sage text-sm dark:text-white" />
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="location" value="{{ old('location') }}" placeholder="Gedung A, Lantai 2"
                            class="w-full px-4 py-2.5 bg-white dark:bg-card-dark border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-sage text-sm dark:text-white" />
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="3"
                            class="w-full px-4 py-2.5 bg-white dark:bg-card-dark border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-sage text-sm dark:text-white">{{ old('description') }}</textarea>
