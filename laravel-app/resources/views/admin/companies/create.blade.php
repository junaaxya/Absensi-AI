...
@section('header-subtitle', 'Menambahkan perusahaan baru ke dalam sistem')
...
@section('content')
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h3 class="font-bold text-xl text-slate-900 dark:text-white">Form Perusahaan Baru</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Lengkapi informasi perusahaan di bawah ini.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="address" rows="3"
                            class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border {{ $errors->has('address') ? 'border-rose-400 ring-2 ring-rose-200' : 'border-slate-200 dark:border-slate-700' }} rounded-xl focus:ring-2 focus:ring-sage focus:border-sage transition-all text-slate-900 dark:text-white font-medium placeholder:text-slate-400"
