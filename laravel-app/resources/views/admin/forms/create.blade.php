...
@section('header-title', 'Buat Form Baru')
...
<div x-data="formBuilder()" class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Buat Form Baru</h1>
        </div>
    </div>
    ...
    <form action="{{ route('admin.forms.store') }}" method="POST" @submit="prepareSubmit()">
        @csrf
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                class="w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-800 focus:border-primary focus:ring-primary text-sm">{{ old('description') }}</textarea>
                        </div>
                    ...
                    <div class="space-y-3">
                        <template x-for="(field, index) in fields" :key="field.id">
                            <div class="border rounded-xl p-4 transition-all"
                                ...
                                {{-- Field Properties Editor (inline when selected) --}}
...
@push('scripts')
<script>
function formBuilder(existingFields = []) {
    return {
